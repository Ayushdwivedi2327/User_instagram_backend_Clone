...
postRouter.get("/", createPostController.getPostController); // GET endpoint for listing posts; controller should handle pagination, filtering, and any security checks
postRouter.get("/details/:postId", createPostController.getPostDetails); // GET endpoint for fetching details of a specific post identified by postId path parameter
